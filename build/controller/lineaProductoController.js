...
class LineaProductoController {
    list(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const query = yield database_1.default.query('select *,linea_producto.id_prodpro,linea_producto.id_linea,prod_provee.id_producto as id_prod ,prod_provee.id_proveedor as id_prov,prod_provee.id_producto,producto.nombre_producto as nom_prod,producto.unidad_medida as unid_med,prod_provee.id_proveedor,proveedor.nombre_proveedor as nom_prov,linea.nombre_linea as nom_linea,linea.id_departamento,departamentos.nombre_departamento as nom_dep from linea_producto inner join prod_provee on linea_producto.id_prodpro=prod_provee.id_prodpro inner join producto on prod_provee.id_producto=producto.id_producto inner join proveedor on prod_provee.id_proveedor=proveedor.id_proveedor inner join linea on linea_producto.id_linea=linea.id_linea inner join departamentos on linea.id_departamento=departamentos.id_departamento');
            res.json(query);
        });
    }
    getOne(req, res) {
