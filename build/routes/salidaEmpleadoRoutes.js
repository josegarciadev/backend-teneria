...
class SalidaEmpleadosRoutes {
    ...
    config() {
        ...
        this.router.get('/getone/:id', salidaEmpleadoController_1.salidaEmpleadosController.getOne);
        this.router.get('/salidas', salidaEmpleadoController_1.salidaEmpleadosController.salida);
